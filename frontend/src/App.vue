...
<template>
  <div class="app">
    <div class="top-controls">
      ...
      <button class="settings-button" @click="showSettings">设置</button>
    ...
    <div class="input-container">
      ...
      <button @click="getResponse">发送</button><!--发射一个自定义事件-->
...
export default { //导出了一个对象,这个对象定义了Vue组件的选项，使得其他文件可以通过import引入并使用这个组件
  ...
  methods: {
    ...
    showSettings() { //切换设置页面的显示
      this.$refs.settingsComponent.toggleSettings();
    },
  },
}
</script>
